...
class Deck:
    ...
    def calculate_lands_landless(self):
        ...
        pls = (black_manna / total_manna)

        # Calculate plains probability
        plp = (white_manna / total_manna)
...
corrupt_court_official = Card("Corrupt Court Official", 1, 0, 1)\

# Sorceries
#duress = Card("Duress", 1, 0, 0)
#pilfer = Card("Pilfer", 1, 0, 1)
soul_transfer = Card("Soul Transfer", 2, 0, 1)
#corrupt = Card("Corrupt", 1, 0, 5)

# Instants
heros_downfall = Card("Heros Downfall", 2, 0, 1)

# Artifacts
lion_sash = Card("Lion Sash", 0, 1, 1)
